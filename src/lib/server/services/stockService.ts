...
export async function getStockLevels(filters: StockFilters = {}): Promise<PaginatedResponse<StockWithProduct>> {
    ...
    const items: StockWithProduct[] = stocks.map((s) => ({
        ...
        supplierDescription: s.product.supplierDescription,
        piecesPerPackage: s.product.piecesPerPackage,
        priceListGBP: Number(s.product.priceListGBP),
        discount1Pct: Number(s.product.discount1Pct),
        costGBP: Number(s.product.costGBP),
        trueCostGBP: Number(s.product.trueCostGBP),
        timbaDescription: s.product.timbaDescription,
        marginPct: Number(s.product.marginPct),
