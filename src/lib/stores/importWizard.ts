        ...
        setFileData: (
            ...
            update(state => ({
                ...
                mapping: {
                    ...
                    discount2: suggestedMappings['discount2'],
                    unitWeight: suggestedMappings['unitWeight'],
                    boxWeight: suggestedMappings['boxWeight'],
                    brand: suggestedMappings['brand'],
                    productGroup: suggestedMappings['productGroup'],
                    unitOfMeasure: suggestedMappings['unitOfMeasure'],
                    hsCode: suggestedMappings['hsCode'],
                    eanCode: suggestedMappings['eanCode'],
                },
                step: 2,
                error: null,
            }));
